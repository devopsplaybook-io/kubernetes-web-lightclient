  ...
  methods: {
    confirmDelete(kubeObject) {
      this.dialogConfirmDelete = {
        ...
        message: `Delete rolebinding ${kubeObject.metadata.name}${kubeObject.metadata.namespace ? ` (${kubeObject.metadata.namespace})` : ""}?`,
    ...
    async onConfirmDelete() {
      ...
      await axios
        ...
        .then(() => {
          ...
          EventBus.emit(EventTypes.OBJECT_CHANGED, "rolebinding");
        })
        .catch(handleError);
    },
    onCancelDelete() {
