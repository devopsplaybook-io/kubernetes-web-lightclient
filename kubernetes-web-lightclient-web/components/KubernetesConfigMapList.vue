  ...
  methods: {
    confirmDelete(kubeObject) {
      this.dialogConfirmDelete = {
        ...
        message: `Delete configmap ${kubeObject.metadata.name}${kubeObject.metadata.namespace ? ` (${kubeObject.metadata.namespace})` : ""}?`,
    ...
    async onConfirmDelete() {
      ...
      await axios
        ...
        .then(() => {
          ...
          EventBus.emit(EventTypes.OBJECT_CHANGED, "configmap");
        })
        .catch(handleError);
    },
    onCancelDelete() {
