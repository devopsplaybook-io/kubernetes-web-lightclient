  ...
  methods: {
    confirmDelete(kubeObject) {
      this.dialogConfirmDelete = {
        ...
        message: `Delete secret ${kubeObject.metadata.name}${kubeObject.metadata.namespace ? ` (${kubeObject.metadata.namespace})` : ""}?`,
    ...
    async onConfirmDelete() {
      ...
      await axios
        ...
        .then(() => {
          ...
          EventBus.emit(EventTypes.OBJECT_CHANGED, "secret");
        })
        .catch(handleError);
    },
    onCancelDelete() {
