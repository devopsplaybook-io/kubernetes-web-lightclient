  ...
  methods: {
    confirmDelete(kubeObject) {
      this.dialogConfirmDelete = {
        ...
        message: `Delete clusterrole ${kubeObject.metadata.name}${kubeObject.metadata.namespace ? ` (${kubeObject.metadata.namespace})` : ""}?`,
    ...
    async onConfirmDelete() {
      ...
      await axios
        ...
        .then(() => {
          ...
          EventBus.emit(EventTypes.OBJECT_CHANGED, "clusterrole");
        })
        .catch(handleError);
    },
    onCancelDelete() {
